<div class="modal fade hideableModal" id="addTeamFormModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
                ...
                <div class="row mb-4">
                    ...
                    >
                        <button
                            ...
                            <img src="{{asset('img/menu-icons/plus-white-icon.svg')}}" alt="" class="w-18 me-3" wire:target="addForm" wire:loading.remove /> Add
                            Form
                        </button>
                        @unlessrole('agent')
                            <button
                            ...
                            <button
                                class="btn btn-lg rounded-pill btn-primary-light text-white shadow-sm text-uppercase"
                                wire:target="destroy" wire:loading.attr="disabled"
                                {{ count($selectedForms) === 0 ? 'disabled' : '' }}
                                data-bs-toggle="modal"
                                data-bs-target="#deleteConfirmationteamformdeleteModal"
                            >
    ...
    <x-modals.delete-confirmation :id="'teamformdelete'" :action='"destroy()"'
                                  :key="time().'teamformdelete'">
