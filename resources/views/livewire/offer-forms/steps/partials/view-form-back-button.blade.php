@auth
    @if($routeIsPreview || (!$routeIsPreview && strpos($offerFormOffer->slug, 'view-form-') !== false))
        @if($routeIsPreview && !is_null($offerFormStep->referral_partner_id))
            <div class="container my-4">
                <a
                    href="{{ request()->has('backTo') ? request()->get('backTo') : route('dash.referral-partners.edit', [$offerFormStep->referralPartner->referralPartnerType->slug, $offerFormStep->referral_partner_id]) }}"
