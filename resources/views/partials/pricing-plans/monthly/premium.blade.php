<div class="col mx-2 py-5" style="background-color: #9C4EDD">
    <div class="card pricing-card py-5 p-3 shadow border-0 rounded-0 ">
        <div class="card-body">
            <div class="" style="height: 100px">
                <h3 class="text-primary text-center mb-3">$10 <span class="fs-14 text-dark">/month</span></h3>
                <h3 class="text-uppercase fw-500  mb-0 text-center">PREMIUM PLAN</h3>
            </div>
            <hr>
