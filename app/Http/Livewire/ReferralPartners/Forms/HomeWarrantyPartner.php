...
class HomeWarrantyPartner extends Component
{
    use WithFileUploads;
    ...
    {
        return view('livewire.referral-partners.forms.home-warranty-partner')->withReferralPartnerType(request()->route('referral_partner_type'));
    }
