...
class LenderPartner extends Component
{
    use WithFileUploads;
    ...
    {
        return view('livewire.referral-partners.forms.lender-partner')->withReferralPartnerType(request()->route('referral_partner_type'));
    }
